...
CTAB	equ	$
	DB	'DUMP'
	DB	((DUMP > 8) & 0FFH), DUMP & 0FFH
	DB	'LIST'
	DB	((LIST > 8) & 0FFH), LIST & 0FFH
	DB	'TEXT'
	DB	((TEXT > 8) & 0FFH), TEXT & 0FFH
	DB	'DELT'
	DB	((DELT > 8) & 0FFH), DELT & 0FFH
	DB	'MODE'
	DB	((MODE > 8) & 00FFH), MODE & 00FFH
	DB	'FCHK'
	DB	((FCHK > 8) & 00FFH), FCHK & 00FFH
	DB	'FORM'
	DB	((FORM > 8) & 00FFH), FORM & 00FFH
	DB	'NFOR'
	DB	((NFOR > 8) & 00FFH), NFOR & 00FFH
	DB	'SWCH'
	DB	((EORNS > 8) & 00FFH), EORNS & 00FFH
	DB	'SIMU'
	DB	((SIMU > 8) & 00FFH), SIMU & 00FFH
	DB	0
	DB	'EXEC'
	DB	((EXEC > 8) & 00FFH), EXEC & 00FFH
	DB	'ENTR'
	DB	((ENTR > 8) & 00FFH), ENTR & 00FFH
	DB	'FILE'
	DB	((FILE > 8) & 00FFH), FILE & 00FFH
	DB	'ASSM'
	DB	((ASSM > 8) & 00FFH), ASSM & 00FFH
	DB	'ASSI'
	DB	((ASSM > 8) & 00FFH), ASSM & 00FFH
	DB	'IODR'
	DB	((IODR > 8) & 00FFH), IODR & 00FFH
	DB	'STAB'
	DB	((STAB > 8) & 00FFH), STAB & 00FFH
	DB	'SYML'
	DB	((SYML > 8) & 00FFH), SYML & 00FFH
	DB	'CUST'
	DB	((CUST > 8) & 00FFH), CUST & 00FFH
	DB	'RNUM'
	DB	((RNUM > 8) & 00FFH), RNUM & 00FFH
	DB	'FMOV'
	DB	((FMOV > 8) & 00FFH), FMOV & 00FFH
	DB	'EDIT'
	DB	((TXT2 > 8) & 00FFH), TXT2 & 00FFH
	DB	'AUTO'
	DB	((AUTO > 8) & 00FFH), AUTO & 00FFH
	DB	'FIND'
	DB	((FIND2 > 8) & 00FFH), FIND2 & 00FFH
	DB	'TERM'
	DB	((TERM > 8) & 00FFH), TERM & 00FFH
	DB	0
;
